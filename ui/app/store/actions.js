...
function updateAndSetCustomRpc (newRpc, chainId, ticker = 'UBQ', nickname, rpcPrefs) {
  return (dispatch) => {
...
function editRpc (oldRpc, newRpc, chainId, ticker = 'UBQ', nickname, rpcPrefs) {
  return (dispatch) => {
...
function setRpcTarget (newRpc, chainId, ticker = 'UBQ', nickname) {
  return (dispatch) => {
