...
async function setupStreams () {
  ...
  pump(
    ...
    pageStream,
    pageMux,
    (err) => logStreamDisconnectWarning('Sparrow Inpage Multiplex', err)
  )
  pump(
    extensionMux,
    extensionStream,
    extensionMux,
    (err) => logStreamDisconnectWarning('Sparrow Background Multiplex', err)
  )
...
function forwardTrafficBetweenMuxers (channelName, muxA, muxB) {
  ...
  pump(
    ...
    channelB,
    channelA,
    (err) => logStreamDisconnectWarning(`Sparrow muxed traffic for channel "${channelName}" failed.`, err)
  )
}
...
function redirectToPhishingWarning () {
  console.log('Sparrow - routing to Phishing Warning component')
